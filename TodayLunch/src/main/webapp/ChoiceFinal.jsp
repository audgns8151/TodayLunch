...
<div id="ChoiceFinal">
		...
		<div id="n_4830">
			<div id="n_368">
				...
				<div id="Tabs">
					...
					<div id="n_143633">
						<div id="Label_bo" onclick="location.href='Main.jsp';">
							<span> 오점 : 오늘의 점심                        </span>
						</div>
						<div id="Label_bp">
							<span> 돌림판 게임</span>
				...
				<div id="Tabs_cg">
					...
					<div id="Tab_Item_cp">
						...
						<div id="Area_cr">
							...
							<svg class="Bar_cu">
								<rect id="Bar_cu" rx="1" ry="1" x="0" y="0" width="42" height="2">
								</rect>
							</svg>
						</div>
					</div>
				...
				<div id="Tabs_cx">
					...
					<div id="Tab_Item_c">
						...
						<div id="Area_da">
							...
							<svg class="Bar_db">
								<rect id="Bar_db" rx="1" ry="1" x="0" y="0" width="42" height="2">
								</rect>
							</svg>
						</div>
					</div>
	...
	<%ChoiceDTO dto = (ChoiceDTO)request.getAttribute("food");%>
	<div id="n____" style="width: 677px;">
		<img src='<%=dto.getImage()%>' width="677"/>
		<br></br>
		<span id="n_"><%=dto.getExplain()%></span>
